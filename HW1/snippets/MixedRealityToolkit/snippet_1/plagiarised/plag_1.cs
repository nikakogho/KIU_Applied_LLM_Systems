...
namespace CustomCode
{
    ...
    public class SceneManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private TextMeshProUGUI resultingText;
        ...
        public void StartTest()
        {
            ...
            resultingText.text = string.Empty;
        ...
        private void Update()
        {
            ...
            else
            {
                // display
                testComplete = true;
                resultingText.text = $"Test dropped below the target framerate after {currentCount} objects.  Test complete.";
                Debug.Log(resultingText.text);
